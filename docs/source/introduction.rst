Introduction to nmrtools v0.2.0 (alpha)
===========================================

**nmrtools** is a library of tools for simulating NMR spectra, starting from
...
The target niche for **nmrtools** are users that want to model NMR spectra but
