...
def test_add_peaks():
    peaklist = [(100, 1.1, 0.5), (110, 1.2, 0.5), (150, 1.6, 0.5)]
    expected_result = (120.0, 3.9, 0.5)
    result = add_peaks(peaklist)
    assert result == expected_result


def test_reduce_peaks():
    refspec = [(293.0, 0.75, 0.5),
               (300.0, 1.5, 0.5),
               (307.0, 0.75, 0.5),
               (432.5, 0.0625, 0.5),
               (439.5, 0.3125, 0.5),
...
def test_normalize_spectrum():
    unnormalized = [(1200.0, 1.0, 0.5), (500.0, 2.0, 0.5)]
    expected = [(1200.0, 2.0, 0.5), (500.0, 4.0, 0.5)]
